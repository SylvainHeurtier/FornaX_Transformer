...
print(" ")
print(f"=== Concatenation des donnees Xamin avec celles sur les amas et les AGN ===")
...
print(f"\nDim de X_train: {X_train.shape}") # Devrait être (n_windows,  MAX_SOURCES * n_features_Xamin + MAX_CLUSTERS * n_features_input + 2)
...
np.savetxt(f'/lustre/fswork/projects/rech/wka/ufl73qn/TransformerProject/results/{name_dir}/X_train.txt', X_train, fmt='%d')
np.savetxt(f'/lustre/fswork/projects/rech/wka/ufl73qn/TransformerProject/results/{name_dir}/X_test.txt', X_test, fmt='%d')

np.save(f'/lustre/fswork/projects/rech/wka/ufl73qn/TransformerProject/results/{name_dir}/X_train.npy', X_train)
np.save(f'/lustre/fswork/projects/rech/wka/ufl73qn/TransformerProject/results/{name_dir}/X_test.npy', X_test)
